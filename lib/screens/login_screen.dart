...
class _LoginScreenState extends State<LoginScreen> {
                  ...
                  children: [
                        ...
                        Column(
                          children: [
                            Text(
                              "GEOFENCING",
                              style:
                                  SpaceTheme.textTheme.displayLarge?.copyWith(
                                fontSize: 36,
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        gradient: SpaceTheme.adminButtonGradient,
                        boxShadow: [
                          BoxShadow(
                            color: SpaceTheme.cosmicPurple.withAlpha(100),
                            blurRadius: 12,
                            spreadRadius: 2,
                          ),
                        ],
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        borderRadius: BorderRadius.circular(30),
                        gradient: SpaceTheme.userButtonGradient,
                        boxShadow: [
                          BoxShadow(
                            color: SpaceTheme.pulsarBlue.withAlpha(100),
                            blurRadius: 12,
                            spreadRadius: 2,
                          ),
                        ],
  ...
  // Show login form in a modal bottom sheet
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                // Title
                Text(
                  _isAdmin ? 'Admin Access' : 'User Access',
